 ...
 */
public class GetCartTask_02_00_00 extends TaskBase<Cart_01_01_00> {
	@Override
	public Cart_01_01_00 execute(Map<String, Object> params) {
		...
		Cart_01_01_00 cart = new Cart_01_01_00(cartId);
		...
		cart.getItems().add(new CartItem_01_00_00("4", 1, "My item 4", 777));

		cart.setTask("GetCartTask_02_00_00");
