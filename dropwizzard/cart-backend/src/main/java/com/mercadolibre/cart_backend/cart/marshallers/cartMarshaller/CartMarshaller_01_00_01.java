 ...
 */
public class CartMarshaller_01_00_01 extends MarshallerBase<Cart_01_00_00> {
	@Override
	public ObjectNode getJson(Cart_01_00_00 cart) {
		cart.setNote(cart.getNote() + " (modified with CartMarshaller_01_00_01)");
		cart.setMarshaller("CartMarshaller_01_00_01");
